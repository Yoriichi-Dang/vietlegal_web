"use client";
import ChatInput from "@/components/chat/old/chat-input";
import HeaderAvatar from "@/components/chat/old/header-avatar";
import Sidebar from "@/components/chat/old/sidebar";
import React, { useCallback, useEffect, useRef, useState } from "react";
import ChatContainerAnimated from "@/components/chat/old/chat-container-animated";
